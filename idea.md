Since the file link isn’t usable in your client, the reliable option is to paste the Markdown directly into your repo from the terminal.

Run this from `/Users/robert/misc-dev/hermes`:

```bash
cat > HERMES_JUPYTER_TUTOR.md <<'EOF'
...
```bash
wc -l HERMES_JUPYTER_TUTOR.md
head -20 HERMES_JUPYTER_TUTOR.md
```

That will write it directly into your real repo.